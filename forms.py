...
from wtforms_validators import ActiveUrl, NumberRange
...
class InsertTourForm(FlaskForm):
    ...
    tour_price = IntegerField('Tour price', validators=[DataRequired(), NumberRange(min=0, max=9999, message="Please provide a valid number")])
